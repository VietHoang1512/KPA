...
class ModelArguments:
    ...
    pair_margin: float = field(default=1.0, metadata={"help": "Margin distance value for pair loss."})
    triplet_margin: float = field(default=1.0, metadata={"help": "Margin distance value for triplet loss."})
